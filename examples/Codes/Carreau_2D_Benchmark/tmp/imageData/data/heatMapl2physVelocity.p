...
set output './tmp/imageData/_l2(physVelocity)iT0003300.jpeg'
} else {set terminal png size 1920,1080font ",25"
set output './tmp/imageData/_l2(physVelocity)iT0003300.png'
}
set pm3d map
unset key
set size ratio -1
...
splot './tmp/imageData/data/l2(physVelocity).matrix' u ($1*0.00506667+-2.22045e-15):($2*0.00506667+-2.22045e-15):3 matrix with pm3d
